...
if __name__ == '__main__':
    ...
    if opt.task in ['val', 'test']:  # run normally
        ...
        y = []
        for opt.iou_thres in range(opt.start,105,5):
            opt.iou_thres = opt.iou_thres/100
            for opt.conf_thres in range(0,105,5):
                opt.conf_thres = opt.conf_thres/100
                print(opt)
                r = test(opt.data,
                     opt.weights,
                     opt.batch_size,
